...
sys.path.insert(
    0, "CIANNA/src/build/lib.linux-x86_64-cpython-311"
)  # your path to CIANNA version
...
cnn.load(
    path_cnn_model + "net0_s%04d.dat" % load_iteration, load_iteration, bin=1
)  # weights loading
cnn.forward(
...
pred = np.fromfile(
    "./fwd_res/net0_%04d.dat" % (load_iteration), dtype="float32"
